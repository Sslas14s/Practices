...
SELECT --2
    c.full_name
FROM Customers c
LEFT JOIN Orders o ON c.customer_id = NULL; 
...
SELECT p.product_name, oi.product_id --8
FROM products p
LEFT JOIN order_items oi ON p.product_id = oi.product_id
WHERE oi.product_id IS NULL

SELECT c.full_name, p.product_name, o.order_date --9
FROM customers c
...
SELECT c.full_name, price from products p --10.2
